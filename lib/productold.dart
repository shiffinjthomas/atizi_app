...
class _ProductState extends State<Product> {
  ...
  // final _key = "2UERA8VW94ILC2BU7QBNH3LUZQF2CYKI"; //live
    ...
    try {
      if (_url != null && _ref == null) {
        if (_url.length == 8) {
          ...
          //     Uri.parse('$_site/shops&display=full&output_format=JSON&$_key'));
          // var data3 = jsonDecode(utf8.decode(response3.bodyBytes));
          // data['store'] = data3['shops'][0];
